...
import { ApproveInstructorDto, StudentCourse } from './admin.dto';
...
export class AdminController {
  ...
  @Post('push-student')
  // @Auth('ADMIN')
  async pushCourse(@Body() body: StudentCourse) {
    console.log(body.email);
    
    return this.adminService.pushCourse(body.courseId,body.email);
  }}
